...
mongoose.connect("mongodb+srv://admin-pratik:Test123@cluster0.eb7fk.mongodb.net/todolistDB?retryWrites=true&w=majority",{ useUnifiedTopology: true, useNewUrlParser: true} );
...
app.get("/",function(req,res){
    ...
    Item.find({},function(err,founditem){
        ...
        res.render("list",{listTitle: day ,newitemlists:founditem});
        }
    });
    ...
    List.findOne({name:customListName},function(err,foundlist){
        if(!err){
            if (!foundlist){
                ...
                res.render("list", {listTitle: foundlist.name , newitemlists: foundlist.item})
            }
        }
    })
});
